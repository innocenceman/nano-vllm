# Change-to-Test Ladder — Tensor-Parallel Linear Layers
            ...
            **Current label:** `exceptioned-deep-partial`
            ...
            - compileall passed
- GitNexus query found tensor-parallel constructors and divide flow
- runtime blocked by missing `torch` and distributed fixture
