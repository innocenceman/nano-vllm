# File Roles — Sampling Parameters

- `nanovllm/sampling_params.py` — source path participating in sampling parameters; inspect before changes and update this packet if ownership shifts.
